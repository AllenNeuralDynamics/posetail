...
python grid_search_lightning.py --config-path configs/config_default.toml --auto-submit
python grid_search_lightning.py --config-path configs/config_default_3d.toml --auto-submit
'''
